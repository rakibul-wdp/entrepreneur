        ...
        <Container className="grid lg:grid-cols-2">
          <div className="space-y-6">
            ...
            <p className="text-[#345f54] text-[18px] font-medium">
              It is a web application that can be used by an organization (such
              as the police) to easily record and track the injuries reported by
              a person
            </p>
            <Button
              type="primary"
          ...
          <div className="hidden lg:block">
            <Image src="/images/its.png" width={640} height={427} alt="" />
          </div>
        </Container>
      </div>
