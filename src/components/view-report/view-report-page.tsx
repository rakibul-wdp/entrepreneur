...
import BackBody from "../create-report/back-body";
import FrontBody from "../create-report/front-body";
      ...
      render: (record) => (
        <div className="flex gap-x-4">
          <Link
            ...
            href={`/create-report/edit/${record.id}`}
          >
            Edit
          </Link>
          <button
    ...
    <>
      ...
      <Container className="py-8">
        <div className="max-w-[100vw] overflow-x-auto">
          <Table pagination={false} columns={cols} dataSource={[data!]} />
        </div>
